function [Sdot del_v1 del_v2 I_tilde Tr Tl tR_ddot rhoR_ddot flong_1]= Robust_controller(t,S,vr,wr,L,Kp,Kd,...
                R,mc,m,I,b,Iwy)
...
if(t==0)
    ...
    rhoR_ddot=0;
    I_tilde_vec=Iwy*ones(1,windowSize);
end
%% Updating I_tilde
...
[I_tilde, I_tilde_vec]=Use_filter(I_tilde_vec,I_tilde,windowSize);
%%
